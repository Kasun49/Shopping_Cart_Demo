...
public class PaymentDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new PostDataTask1().execute("http://"+common.ip+":4000/apii/email1");
    ...
    public class GetDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(PaymentDetails.this, commontw.idew, Toast.LENGTH_SHORT).show();


            new PaymentDetails.PutDataTask().execute("http://"+ common.ip+":4000/apii/editstore/"+commontw.idew.trim(),"yes");
            new PaymentDetails.PostDataTask().execute("http://"+common.ip+":4000/apii/addpurch");
    ...
    class PutDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(PaymentDetails.this,strI, Toast.LENGTH_SHORT).show();
    ...
    public class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(PaymentDetails.this," New purchase added", Toast.LENGTH_SHORT).show();
    ...
    public class PostDataTask1 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(PaymentDetails.this," Email was sent", Toast.LENGTH_SHORT).show();
